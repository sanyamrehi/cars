...
<body>
    <div class="container mt-5">
        ...
        <!-- Form -->
        <form action="{{ route('vehicles.update',['id' => $table['id']]) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            <div class="mb-3">
                <label for="colors" class="form-label">select any colors:</label>
